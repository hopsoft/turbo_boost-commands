...
class IncrementRpcWithoutFramesTest < ApplicationSystemTestCase
  test "rpc-over-http" do
    ...
    # execute demo
    demo_element.wait_for_selector("[data-turbo-command='CounterRpcCommand#increment']").click
    sleep 0.1
    ...
    assert demo_element.wait_for_selector("[data-command-requested='true'][data-command-performing='true'][data-command-performed='false']")
